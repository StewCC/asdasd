...
module.exports = {
    info: {
        name: "owner",
        description: "[ Staff Only ] Give users the owner role.",
        usage: "[user] [clan]",
        aliases: []
    },
...
member.roles.add(ClanOwner).catch(console.error)
member.roles.remove(Clanless).catch(console.error)
let username1 = `[${args[1]}/Owner] ${member.user.username}`;
